...
```json
{
  ...
  "payload": {
    "query": "Test quality context needed: testing guidelines location (/home/node/.claude/docs/coding-guidelines/), recent git changes to test files, review priorities, critical testing patterns to check, and project-specific test conventions."
  }
}
```
...
- Reference testing guidelines from `/home/node/.claude/docs/coding-guidelines/`
...
**2. Manual Mock Implementation** (NEVER DO THIS):
```go
...
### Missing Suite Setup
**Severity**: Important - Tests may fail in different timezones or truncate diffs
