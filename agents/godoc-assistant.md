...
```json
{
  ...
  "payload": {
    "query": "Documentation context needed: recent code changes scope, exported items without docs, package structure, coding guidelines location (/home/node/.claude/docs/coding-guidelines/go-doc-best-practices.md), and domain-specific terminology."
  }
}
```
...
- Follow `/home/node/.claude/docs/coding-guidelines/go-doc-best-practices.md`
