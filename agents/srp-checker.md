...
```json
{
  ...
  "payload": {
    "query": "SRP context needed: recent changes scope, critical components to review, coding guidelines location (/home/node/.claude/docs/coding-guidelines/), existing architectural patterns, and areas prone to responsibility mixing."
  }
}
```
